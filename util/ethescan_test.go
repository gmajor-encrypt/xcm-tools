...
func Test_EtherApi(t *testing.T) {
	t.Run("Test_EthGetTransactionByHash", func(t *testing.T) {
		type args struct {
			ctx  context.Context
			hash string
		}
	...
	t.Run("Test_EthGetTransactionReceipt", func(t *testing.T) {
		type args struct {
			ctx  context.Context
			hash string
		}
	...
	t.Run("Test_EthGetBlockByNum", func(t *testing.T) {
		type args struct {
			ctx      context.Context
			blockNum uint64
		}
	...
	time.Sleep(1 * time.Second)
	t.Run("TestEtherscanGetLogs", func(t *testing.T) {
		type args struct {
			ctx       context.Context
			fromBlock uint64
			address   string
